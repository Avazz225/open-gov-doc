...
- `dms-retry/` — geteilte Backoff-/Jitter-Mathematik (Full Jitter, AWS-Standardformel) für Retry-Poll-Loops, **kein** gemeinsamer Poll-Loop-Rahmen (Post-Roadmap Phase 20 Session 1)
