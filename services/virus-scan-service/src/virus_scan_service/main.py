...
# Max upload size (Phase 61 Session 2, ADR 0187) - `POST /scan` previously
# read the entire uploaded file into memory (`await file.read()`) with no
# size cap anywhere in-process or at any layer in front of this service.
# Must be added here, at module level right after `app` is constructed -
