...
| P7-S1b | Aufbewahrung/Legal Hold + Zwangslöschung inkl. Löschregister (5.2/5.2a) — **für Ordner**, überträgt das in P7-S1 gebaute Muster 1:1. Ordner haben bislang **kein** Soft-Delete-Konzept überhaupt (anders als Dokumente mit ihrem seit langem vorhandenen rohen `deleted_at`) — diese Session muss es dafür erst grundlegend einführen, bevor Papierkorb/Wiederherstellungsfrist/Zwangslöschung/Löschregister analog zu P7-S1 aufgesetzt werden können. `ObjectType.default_retention_days`/`deletion_reason_required_override` sind bereits objektartübergreifend nutzbar (siehe P7-S1), hier nur noch anzuwenden. *(Neu eingeschoben bei P7-S1-Planfreigabe, siehe P7-S1-Zeile oben und `PROGRESS.md`.)* |
