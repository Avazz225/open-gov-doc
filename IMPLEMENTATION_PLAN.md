...
| P7-S2b | Reporting Service (Standardberichte, 5.4a) — neuer Service, Read-Modell-Aggregationen über den Event-Strom (Dokumentenaufkommen, offene Workflow-Aufgaben, Lizenzauslastung, Speicherverbrauch, Nutzeraktivität), CSV/PDF-Export, planbarer Versand über den Notification Service. *(Bei P7-S2-Planfreigabe verschoben, siehe `PROGRESS.md`.)* |
