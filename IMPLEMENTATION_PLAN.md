...
**60 Sessions insgesamt** (ursprünglich 43, seit P4-S3 um P4-S4/S5/S6 und P6-S6 ergänzt — direktes Nutzer-Feedback nach dem ersten echten Browser-Test des MVP; seit P5-S4 um Phase 5b (P5b-S1–S6) ergänzt — nachträglicher Ausbauwunsch nach Abschluss der Verarbeitungs-Phase; seit P5b-S6 um Phase 5c (P5c-S1/S2) ergänzt — Konsolidierungsrunde offener Punkte; seit P5c-S2 um Phase 5d (P5d-S1/S2) ergänzt — Nutzer-Feedback zu Vorschau-Lücken/OCR-Kostenkontrolle/Format-Governance/Upload-UX; seit P5d-S2 um Phase 5e (P5e-S1–S3) ergänzt — Nutzerwunsch nach einem konfigurierbaren Kennzeichengenerator (Aktenzeichen), siehe `PROGRESS.md`), davon 12 bis zum MVP-Meilenstein (P4-S3).
