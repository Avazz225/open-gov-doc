...
| P7-S2c | Forensik-Trace (5.4b) — objektbezogene Nachverfolgung ("alle Aktionen von Nutzer X"/"alle Nutzer auf Dokument Y"), zentraler Anwendungsfall kompromittierter Account, baut direkt auf der in P7-S2 gebauten Filter-API auf. Zeitfenster-/Aktionstyp-Filter, Export, selbst auditierter Zugriff, optionale regelbasierte Anomalie-Hinweise (statische Schwellwerte, keine ML-Erkennung). *(Bei P7-S2-Planfreigabe verschoben, siehe `PROGRESS.md`.)* |
