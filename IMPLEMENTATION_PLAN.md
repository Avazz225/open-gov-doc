...
| P7-S1d | Favoriten/Merkliste für Akten und Ordner (schnelles Wiederfinden), inhaltlich unabhängig von Aufbewahrung/Löschung. Schlankes, rein nutzerbezogenes Feature (`user_id`/`object_type`/`object_id`), Kontextmenü-Eintrag + Filteransicht in `user-ui`. *(Rückfrage bei P7-S1b-Planfreigabe, siehe `PROGRESS.md`.)* |
