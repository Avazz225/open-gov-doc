...
| P7-S3b | XDOMEA-Aussonderung für Umlaufmappen (`case-service`, 5.6) — aufbauend auf der in P7-S3 gebauten Transfer-Infrastruktur (`archival-service`). Eigenserialisierung gegen die offiziellen XDOMEA-3.0.0-XSD-Schemata via `lxml` (ADR 0029, kein Bibliotheks-Import). |
