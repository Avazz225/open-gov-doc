...
// webServer entry here on purpose: user-ui is served as a static export via
// nginx inside the stack, not started by this config.
export default defineConfig({
  ...
  reporter: [["list"]],
  use: {
    baseURL: process.env.USER_UI_BASE_URL || "http://localhost:3000",
