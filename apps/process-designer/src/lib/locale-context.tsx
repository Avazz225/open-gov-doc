...
// UI display language (8, Phase 47 Session 1) - same cross-device pattern
...
export function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  // error #418) - so the first client render matches the server
  // exactly, and the cached choice is applied only after mount below.
