...
- **Kein Rollen-/Berechtigungscheck auf den neuen Aussonderungs-Endpunkten** (5.6, seit P7-S3b) — gleiche bestehende Lücke wie oben, konsistent mit `archival-service`s eigenem Offene-Punkte-Eintrag.
