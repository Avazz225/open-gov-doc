...
| `/object-types/` | Objekttypen anlegen/bearbeiten/löschen über einen geführten Formular-Assistenten (`ObjectTypeEditor`, seit P5b-S3) + Formular-Layout-Designer (`LayoutDesigner`, 2.2b) |
...
| `/ocr-settings/` | Maximale Wortobergrenze/Verarbeitungs-Batch-Size des OCR Service (`OcrSettings`, seit P5b-S5) |
