...
| `/object-types/` | Objekttypen anlegen/bearbeiten/löschen über einen geführten Formular-Assistenten (`ObjectTypeEditor`, seit P5b-S3, seit P5e-S3 inkl. Kennzeichengenerator-Format/Anzeige-Override) + Formular-Layout-Designer (`LayoutDesigner`, 2.2b) |
...
| `/superuser/` | Superuser-Break-Glass-Status + Aktivierung anfordern/genehmigen (`SuperuserBreakGlass`, 4.6, seit P6-S5) — dünner Aufrufer der bestehenden generischen Approval-Endpunkte des Permission Service (P6-S4) |
