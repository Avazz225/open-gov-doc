...
- **No elevated audit priority for emergency-shutdown events** (4.8, since P6-S6): `AuditEvent` still has no priority field, see ADR 0023/0024. **Reconfirmed still deliberately unbuilt in P71-S2** ([ADR 0206](../adr/0206-p71s2-forensic-trace-coverage-bundle.md)) after a third look found no new justification — treat as settled unless a genuinely new trigger emerges.
