...
see `docs/services/user-ui.md`) — case-level export still has no frontend entry point.
...
- **No frontend entry point this session** — same deliberate scoping as
  ...
  [ADR 0140](../adr/0140-xjustiz-frontend-export-entry-point.md) and `docs/services/user-ui.md`.)
...
- **No frontend entry point** — API-only, same reasoning as the export direction above; a frontend button
  is P34-S2's separate concern.
