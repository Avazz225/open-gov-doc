...
flowchart TB
    ...
    subgraph Backend["Backend-Services (je eigenes Postgres-Schema, 3.1)"]
        ...
        Workflow["workflow-service\nBPMN-Import/-Ausführung, Manual/Automatic Tasks,\nSLA-Zeitüberwachung, Prozess-Versionierung (7.1, ADR 0018/0019/0020/0027)"]
    ...
    NATS -->|"workflow.task.escalated, auth.superuser.activated, permission.maintenance_mode.activated"| Notification
